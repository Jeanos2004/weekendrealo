...
export function DashboardSidebar({ isCollapsed, onToggle, isMobileOpen, onMobileClose }: DashboardSidebarProps) {
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-sidebar-border">
          ...
          >
            <div className="w-8 h-8 bg-sidebar-primary rounded-lg flex items-center justify-center">
              <span className="text-sidebar-primary-foreground font-bold text-sm">WR</span>
            </div>
            <span className="font-bold text-lg text-sidebar-foreground">WeekendRealo</span>
          </Link>
          ...
          <Button
            ...
            size="sm"
            onClick={onToggle}
            className={cn("hidden lg:flex text-sidebar-foreground hover:bg-sidebar-accent", isCollapsed && "mx-auto")}
          >
